...
class ArticleIndex extends Component {
    ...
    deleteItem(id) {
        axios.delete(`/api/articles/delete/${id}`).then(response => {
                                                ...
                                                <tr key={i}>
                                                    ...
                                                    <td width="200" className='text-center'>
                                                        <div className='btn-group'>
                                                            <Link
                                                                className='btn btn-primary' to={`/article/${article.id}`}>
                                                                Detail
                                                            </Link>
                                                            <Link
                                                                className='btn btn-success' to={`/article/edit/${article.id}`}>
                                                                Edit
                                                            </Link>
                                                            <button
